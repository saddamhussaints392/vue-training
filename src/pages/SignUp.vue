      ...
      <b-col cols="12" sm="12" md="12" lg="3">
        <div class="signup_main">
          ...
          <div class="position-relative name_field mt-4">
            <b-form-input class="rounded-0" placeholder="Name"></b-form-input>
          ...
          <div class="position-relative email_field mt-3">
            <b-form-input class="rounded-0" placeholder="Email"></b-form-input>
          ...
          <div class="position-relative password_field mt-3">
            <b-form-input class="rounded-0" placeholder="Password"></b-form-input>
          ...
          <div class="mt-4">
            <button class="btn_signup w-100">Sign Up</button>
          </div>
          ...
          <div class="d-flex w-100 btn_google_signup mt-3 align-items-center justify-content-between">
            <img src="../assets/images/Google.png" alt="" class="d-block pl-3">
          <span class="d-block">Sign up with Google</span>
          <span></span>
          </div>
          <div class="d-flex w-100 btn_apple_signup mt-3 align-items-center justify-content-between">
            <img src="../assets/images/Apple.png" alt="" class="d-block pl-3">
          <span class="d-block">Sign up with Apple</span>
          <span></span>
          </div>
        </div>
      </b-col>
...
.btn_signup,.btn_google_signup,.btn_apple_signup {
  background: #ff9f0d;
  padding-top: 10px;
  padding-bottom: 10px;
  font-family: "Helvetica";
...
.btn_google_signup, .btn_apple_signup {
  color: #4f4f4f;
